...
@section('contentAdmin')
    ...
    <br><br>
    <h1>Profile</h1>
    <form action= "{{route('ban')}}" class "form-group" method = "POST">
        {{csrf_field()}}
        <input type="hidden" name="userID" value="{{ $users['userID']; }}">
        
        <div class="form-group">
          
            <input type="hidden" class="form-control" id="verified" name="verified" placeholder="verified" value="banned">
        ...
        <div class="form-group p-1">
            <span>
                <input type="submit" name="update" value="Ban" class="btn btn-info">
            </span>
        </div>
    </form>
    </div>
