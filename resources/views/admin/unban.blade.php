...
@section('contentAdmin')
    ...
    <br><br>
    <h1>Profile</h1>
    <form action= "{{route('unban')}}" class "form-group" method = "POST">
        {{csrf_field()}}
        <input type="hidden" name="userID" value="{{ $users['userID']; }}">
        
        <div class="form-group">
            
            <input type="hidden" class="form-control" id="verified" name="verified" placeholder="verified" value="true">
        ...
        <div class="form-group p-1">
            <span>
                <input type="submit" name="update" value="Unban" class="btn btn-info">
            </span>
        </div>
    </form>
    </div>
